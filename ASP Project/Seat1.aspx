<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Seat1.aspx.cs" Inherits="ASPProjekti.Seat1" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="zara5" TagPrefix="larsson5"  %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <larsson5:zara5 ID="zara5" runat="server" />
</asp:Content>

<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
      <br />
    <form id="Form1" runat="server">
    <h2 style="text-align:center;"> Welcome, <asp:Label ID="Label1" ForeColor="#ff6699" runat="server" Text="Label"></asp:Label>. SELECT <b> ONE  </b>  CHAIR BELOW! <br />
        Or, you can Sign Off  <asp:Button ID="Button1" ForeColor="#ff3399" Width="100px" Height="50px" BorderColor="Pink" BorderStyle="Dotted" runat="server" Text="HERE" OnClick="Button1_Click" /> 
         ...
         <br /> <div class="col-md-4"> <div style="margin-left:235px;">  <asp:ImageButton ID="ImageButton50"  ImageUrl="~/icons/rsz_sofa-128.png" runat="server"  /><br />&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label5" runat="server" ForeColor="#ff6699" Text="Free"></asp:Label><br /></div>  </div>
            ...
            <div class="col-md-4"> <div style="margin-left:100px;"> <asp:ImageButton ID="ImageButton51"  ImageUrl="~/icons/rsz_sofa-128.png" runat="server" OnClick="ImageButton51_Click"  /> <br />&nbsp;&nbsp;&nbsp;  <asp:Label ID="Label6" runat="server" ForeColor="#ff6699" Text="Taken"></asp:Label><br /> <br /> </div> </div>
        <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                                     <br />                                 <center><asp:Label ID="Label2" runat="server" ForeColor="#ff6699" Text="B"></asp:Label></center>
 ...
 <hr style="background-color:#cf105c; height:4px;" />
             ...
             <div class="col-md-6" > <div style="margin-left:220px; " > <asp:ImageButton ID="ImageButton49"  ImageUrl="~/icons/cloud-hand-128.png" runat="server" OnClick="ImageButton49_Click" /><br /> &nbsp;&nbsp;&nbsp;&nbsp;  <asp:Label ID="Label17" runat="server" ForeColor="#ff6699" Text="Select a seat"></asp:Label> <br /> <br /> <br/> </div>  </div>
            <div class="col-md-3"> </div>
            </div>
            </div>
        </form>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
        ...
        <larsson5:zara5 ID="zara1" runat="server" />
