...
namespace ASPProjekti
{
    public partial class Seat1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Seats", con);
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label9.Text  + "')", con);
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label10.Text + "')", con);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label11.Text + "')", con);
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label12.Text + "')", con);
        ...
        protected void ImageButton17_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label13.Text + "')", con);
        ...
        protected void ImageButton18_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label14.Text + "')", con);
        ...
        protected void ImageButton19_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label15.Text + "')", con);
        ...
        protected void ImageButton20_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label16.Text + "')", con);
        ...
        protected void ImageButton33_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label18.Text + "')", con);
        ...
        protected void ImageButton34_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label19.Text + "')", con);
        ...
        protected void ImageButton35_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label20.Text + "')", con);
        ...
        protected void ImageButton36_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=ISENMURATI\\SQL2012;Initial Catalog=AirlineWeb;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Seats VALUES('" + Label21.Text + "')", con);
