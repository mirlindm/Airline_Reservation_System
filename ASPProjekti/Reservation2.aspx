<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="Reservation2.aspx.cs" Inherits="ASPProjekti.Reservation2" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="Zara" TagPrefix="Larsson" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <Larsson:Zara ID="zara1" runat="server" />
</asp:Content>
    ...
    <h2 style="text-align:center;"> Welcome, <asp:Label ID="Label1" ForeColor="#ff6699" runat="server" Text="Label"></asp:Label>. You can start your reservations below! <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                 ...
                 <hr style="background-color:#cf105c; height:4px;" />
                 <center> <asp:Label ID="Label16" runat="server" ForeColor="#ff6699" Text="Person 2"></asp:Label></center> <br />
                                <asp:Label ID="Label9" runat="server" Text="FirstName:" Font-Bold="True"></asp:Label>
                                <asp:TextBox ID="TextBox5" CssClass="form-control"  placeholder="FirstName" runat="server"></asp:TextBox><br />
                                 <asp:Label ID="Label10" runat="server" Text="LastName:" Font-Bold="True"></asp:Label>
                                <asp:TextBox ID="TextBox6" CssClass="form-control" placeholder="LastName"  runat="server"></asp:TextBox><br />
                                 <asp:Label ID="Label11" runat="server" Text="Age:" Font-Bold="True"></asp:Label>
                    ...
                    <asp:ListItem>Female</asp:ListItem>
                                                ...
                                                <asp:Label ID="Label13" runat="server" Text="BirthDate:" Font-Bold="True"></asp:Label>
                                   ...
                                   <center> <asp:Label ID="Label14" runat="server" ForeColor="#ff6699" Text="Insert your data"></asp:Label></center>
            ...
            <div class="col-md-3"> </div>
             <div class="col-md-6" > <div style="margin-left:220px;"> <asp:ImageButton ID="ImageButton3"  ImageUrl="~/icons/rsz_single-seater-djinn-chair.png" runat="server" OnClick="ImageButton3_Click" /><br />  <asp:Label ID="Label17" runat="server" ForeColor="#ff6699" Text="SELECT TWO SEATS"></asp:Label> <br /> <br /> </div>  </div>
            <div class="col-md-3"> </div>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <Larsson:Zara ID="zara2" runat="server" />
</asp:Content>
