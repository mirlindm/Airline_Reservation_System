<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Seat2.aspx.cs" Inherits="ASPProjekti.Seat2" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="zara6" TagPrefix="larsson6" %>

<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <larsson6:zara6 ID="zara6" runat="server" />
</asp:Content>

<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
      <br />
    <form id="Form1" runat="server">
    <h2 style="text-align:center;"> Welcome, <asp:Label ID="Label1" ForeColor="#ff6699" runat="server" Text="Label"></asp:Label>. SELECT <b> TWO  </b>  CHAIRS BELOW! <br />
 ...
 <hr style="background-color:#cf105c; height:4px;" />
             ...
             <div class="col-md-6" > <div style="margin-left:220px;"> <asp:ImageButton ID="ImageButton49"  ImageUrl="~/icons/cloud-hand-128.png" runat="server" OnClick="ImageButton49_Click" /><br />  <asp:Label ID="Label17" runat="server" ForeColor="#ff6699" Text="SELECT TWO SEATS"></asp:Label> <br /> <br /> </div>  </div>
            <div class="col-md-3"> </div>
            </div>
            </div>
        </form>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <larsson6:zara6 ID="zara1" runat="server" />
</asp:Content>
