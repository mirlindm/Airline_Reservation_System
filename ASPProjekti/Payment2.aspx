<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Payment2.aspx.cs" Inherits="ASPProjekti.Payment2" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="zara10" TagPrefix="larsson10" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <larsson10:zara10 ID="zara10" runat="server" />
</asp:Content>
...
<br />
    ...
    <h2 style="text-align:center;"> Welcome, <asp:Label ID="Label1" ForeColor="#ff6699" runat="server" Text="Label"></asp:Label>. You can make your payments below! <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
         <hr style="background-color:#cf105c; height:4px;" />
                                                 <center> <asp:Label ID="Label13" runat="server" ForeColor="#ff6699" Text="Payment 2"></asp:Label></center> <br />
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <larsson10:zara10 ID="zara1" runat="server" />
</asp:Content>
