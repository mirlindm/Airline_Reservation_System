<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="Reservation4.aspx.cs" Inherits="ASPProjekti.Reservation4" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="zara3" TagPrefix="larsson3"  %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <larsson3:zara3 ID="zara3" runat="server" />
</asp:Content>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
  ...
  <div class="col-md-3">
        <hr style="background-color:#cf105c; height:4px;" />
                 <center> <asp:Label ID="Label24" runat="server" ForeColor="#ff6699" Text="Person 4"></asp:Label></center> <br />
                                <asp:Label ID="Label25" runat="server" Text="FirstName:" Font-Bold="True"></asp:Label>
                                <asp:TextBox ID="TextBox13" CssClass="form-control" placeholder="FirstName" runat="server"></asp:TextBox><br />
                                 <asp:Label ID="Label26" runat="server" Text="LastName:" Font-Bold="True"></asp:Label>
                                <asp:TextBox ID="TextBox14" CssClass="form-control" placeholder="LastName" runat="server"></asp:TextBox><br />
                                 <asp:Label ID="Label27" runat="server" Text="Age:" Font-Bold="True"></asp:Label>
                                <asp:TextBox ID="TextBox15" CssClass="form-control" placeholder="Age" runat="server"></asp:TextBox><br />
                                 <asp:Label ID="Label28" runat="server" Text="Gender:" Font-Bold="True"></asp:Label>
                    ...
                    <asp:ListItem>Female</asp:ListItem>
                                                ...
                                                <asp:Label ID="Label29" runat="server" Text="BirthDate:" Font-Bold="True"></asp:Label>
                                                <asp:TextBox ID="TextBox16" CssClass="form-control" placeholder="Date in this format: yyyy-mm-dd" runat="server"></asp:TextBox><br />
                                           
                                               <center> <asp:ImageButton ID="ImageButton4"  ImageUrl="~/icons/reservee.png" Width="50" Height="50" runat="server" OnClick="ImageButton4_Click"   /> </center>
                                   <center> <asp:Label ID="Label30" runat="server" ForeColor="#ff6699" Text="Insert your data"></asp:Label></center>
      ...
      <div class="col-md-3"> </div>
             <div class="col-md-6" > <div style="margin-left:220px;"> <asp:ImageButton ID="ImageButton5"  ImageUrl="~/icons/rsz_single-seater-djinn-chair.png" runat="server" OnClick="ImageButton5_Click" /><br />  <asp:Label ID="Label31" runat="server" ForeColor="#ff6699" Text="SELECT FOUR SEATS"></asp:Label> <br /> <br /> </div>  </div>
            <div class="col-md-3"> </div>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <larsson3:zara3 ID="zara1" runat="server" />
</asp:Content>
