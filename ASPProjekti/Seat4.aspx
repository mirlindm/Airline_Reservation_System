<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="Seat4.aspx.cs" Inherits="ASPProjekti.Seat4" %>
<%@ Register Src="~/WebUserControl3.ascx" TagName="zara8" TagPrefix="larsson8" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <larsson8:zara8 ID="zara8" runat="server" />
</asp:Content>

<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <br />
    <form id="Form1" runat="server">
    <h2 style="text-align:center;"> Welcome, <asp:Label ID="Label1" ForeColor="#ff6699" runat="server" Text="Label"></asp:Label>. SELECT <b>FOUR  </b>  CHAIRS BELOW! <br />
        Or, you can Sign Off  <asp:Button ID="Button1" ForeColor="#ff3399" Width="100px" Height="50px" BorderColor="Pink" BorderStyle="Dotted" runat="server" Text="HERE" OnClick="Button1_Click" /> 
         ...
         <br /> <div class="col-md-4"> <div style="margin-left:235px;">  <asp:ImageButton ID="ImageButton50"  ImageUrl="~/icons/rsz_sofa-128.png" runat="server"  /><br />&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label5" runat="server" ForeColor="#ff6699" Text="Free"></asp:Label><br /></div>  </div>
             <div class="col-md-4" > <div style="margin-left:180px;"> <asp:ImageButton ID="ImageButton52" Width="80" Height="70"  ImageUrl="~/icons/cancel.png" runat="server" OnClick="ImageButton52_Click" /><br />&nbsp;&nbsp;&nbsp;  <asp:Label ID="Label8" runat="server" ForeColor="#ff6699" Text="Cancel"></asp:Label> <br /></div>  </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <br />
                               <center>    <asp:Label ID="Label2" runat="server" ForeColor="#ff6699" Text="A"></asp:Label> </center>

                                                <hr style="background-color:#cf105c; height:4px;" />
               <div style="margin-left:25px;"> 
                   <asp:ImageButton ID="ImageButton1" ImageUrl="~/icons/rsz_sofa-128.png" runat="server" OnClick="ImageButton1_Click1"  /> <asp:Label ID="Label9" runat="server" Text="A1"></asp:Label>
            ...
            <div class="col-md-4"> <br />
                                                      <center><asp:Label ID="Label3" runat="server" ForeColor="#ff6699" Text="B"></asp:Label></center>

 <hr style="background-color:#cf105c; height:4px;" />
               <div style="margin-left:25px;">

                    <asp:ImageButton ID="ImageButton17" ImageUrl="~/icons/rsz_sofa-128.png" runat="server" OnClick="ImageButton17_Click" /><asp:Label ID="Label13" runat="server" Text="B1"></asp:Label>
 ...
 <hr style="background-color:#cf105c; height:4px;" />
               <div style="margin-left:25px;"> 
                   ...
                   <asp:ImageButton ID="ImageButton33" ImageUrl="~/icons/rsz_sofa-128.png" runat="server" OnClick="ImageButton33_Click"  /> <asp:Label ID="Label18" runat="server" Text="C1"></asp:Label>
             ...
             <div class="col-md-6" > <div style="margin-left:220px;"> <asp:ImageButton ID="ImageButton49"  ImageUrl="~/icons/cloud-hand-128.png" runat="server" OnClick="ImageButton49_Click" /><br />  <asp:Label ID="Label17" runat="server" ForeColor="#ff6699" Text="SELECT FOUR SEATS"></asp:Label> <br /> <br /> </div>  </div>
            <div class="col-md-3"> </div>
            </div>
            </div>
        </form>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <larsson8:zara8 ID="zara1" runat="server" />
</asp:Content>
